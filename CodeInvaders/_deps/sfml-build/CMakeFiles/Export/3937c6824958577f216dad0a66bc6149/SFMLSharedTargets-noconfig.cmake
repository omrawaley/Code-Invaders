...
set_target_properties(sfml-system PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libsfml-system.2.6.0.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libsfml-system.2.6.dylib"
  )

list(APPEND _cmake_import_check_targets sfml-system )
list(APPEND _cmake_import_check_files_for_sfml-system "${_IMPORT_PREFIX}/lib/libsfml-system.2.6.0.dylib" )
...
set_target_properties(sfml-window PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libsfml-window.2.6.0.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libsfml-window.2.6.dylib"
  )

list(APPEND _cmake_import_check_targets sfml-window )
list(APPEND _cmake_import_check_files_for_sfml-window "${_IMPORT_PREFIX}/lib/libsfml-window.2.6.0.dylib" )
...
set_target_properties(sfml-network PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libsfml-network.2.6.0.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libsfml-network.2.6.dylib"
  )

list(APPEND _cmake_import_check_targets sfml-network )
list(APPEND _cmake_import_check_files_for_sfml-network "${_IMPORT_PREFIX}/lib/libsfml-network.2.6.0.dylib" )
...
set_target_properties(sfml-graphics PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libsfml-graphics.2.6.0.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libsfml-graphics.2.6.dylib"
  )

list(APPEND _cmake_import_check_targets sfml-graphics )
list(APPEND _cmake_import_check_files_for_sfml-graphics "${_IMPORT_PREFIX}/lib/libsfml-graphics.2.6.0.dylib" )
...
set_target_properties(sfml-audio PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libsfml-audio.2.6.0.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libsfml-audio.2.6.dylib"
  )

list(APPEND _cmake_import_check_targets sfml-audio )
list(APPEND _cmake_import_check_files_for_sfml-audio "${_IMPORT_PREFIX}/lib/libsfml-audio.2.6.0.dylib" )
